...
def ingest_data():
    ...
    #
    nombrecolumna = ['cluster', 'cantidad de palabras clave', 'porcentaje de palabras clave', 'principales palabras clave']
   
    column_widths = [5, 7, 19, 100]

    df = pd.read_fwf('clusters_report.txt', widths=column_widths, names=nombrecolumna, skiprows=4)
